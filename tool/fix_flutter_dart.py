              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: Text(text, style: const TextStyle(color: _text, fontWeight: FontWeight.w600))),
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: Icon(_listening ? Icons.mic : Icons.mic_none_rounded, color: _listening ? _pink : _muted),
                      ),
                      IconButton(
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(colors: _busy ? [_gold, _pink] : [_purple, _pink]),
                            ),
                            child: Icon(_busy ? Icons.stop_rounded : Icons.arrow_upward_rounded, color: Colors.white),
                          ),
                        ),
                      ),
                    ],
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(
                          _busy ? 'Generating live • Tap stop' : (_listening ? 'Listening…' : 'Live token streaming enabled'),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(attachment.name, style: const TextStyle(color: _text, fontSize: 12), overflow: TextOverflow.ellipsis)),
          IconButton(onPressed: () => setState(() => _attachment = null), icon: const Icon(Icons.close, color: _muted, size: 18)),
        ],
      ),
    );
  }
...
'''
    ...
    # Remove parser-fragile collection-if syntax from the bubble and use a normal ternary.
    text = text.replace(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: user ? _purple.withOpacity(.21) : Colors.white.withOpacity(.065),
                    ...
                    child: RichText(
                      text: TextSpan(
                        style: const TextStyle(color: _text, fontSize: 15, height: 1.5),
                        children: [
                          TextSpan(text: message.text),
                          streaming
                              ? const TextSpan(text: ' ▌', style: TextStyle(color: _purple, fontWeight: FontWeight.w900))
                              : const TextSpan(text: ''),
                        ],
                      ),
                    ),
            ...
            streaming
                ? const Padding(
                    ...
                    child: Text('Generating', style: TextStyle(color: _muted, fontSize: 9)),
                  )
                : const SizedBox.shrink(),
          ],
        ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(label, style: const TextStyle(color: _muted, fontSize: 9, fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ),
