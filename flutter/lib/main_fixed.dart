      ...
      body: ListView(
        ...
        children: [
          ...
          if (editing) ...[
            ...
            const SizedBox(height: 14),
            const _InfoCard(icon: Icons.workspace_premium_outlined, title: 'Destiny AI Free', subtitle: 'Your current plan', action: 'Upgrade'),
...
class _InfoCard extends StatelessWidget {
  ...
  final String action;
  const _InfoCard({required this.icon, required this.title, required this.subtitle, required this.action});
  @override
