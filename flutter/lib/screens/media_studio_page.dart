  ...
  Future<void> generate() async {
    ...
    try {
      ...
      if (tab == 0) {
        ...
        data =
            await MediaService.generateVideo(prompt: value, sound: videoSound);
        ...
        data = await MediaService.generateMusic(
            prompt: value, lyrics: lyrics.text, instrumental: instrumental);
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              maxLines: 8,
                              style: const TextStyle(
                                  color: studioText, fontSize: 16, height: 1.4),
                              decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(
                                        color:
                                            studioPurple.withValues(alpha: .65),
                                        width: 1.2)),
                              ...
                              if (!instrumental) ...[
                                ...
                                TextField(
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        labelStyle:
                                            const TextStyle(color: studioMuted),
                                        hintText:
                                ...
                                child: FilledButton.icon(
                                  ...
                                  style: FilledButton.styleFrom(
                                      ...
                                      disabledBackgroundColor:
                                          studioPurple.withValues(alpha: .35),
                        ...
                        child: Row(children: [
                          if (busy)
                            const SizedBox(
                                ...
                                height: 16,
                                child: CircularProgressIndicator(
                                    strokeWidth: 2, color: studioPink))
                          else
                            const Icon(Icons.check_circle_rounded,
                                size: 18, color: studioPink),
                  ...
                  if (mediaUrl != null) ...[
                    const SizedBox(height: 18),
                    _ResultGlass(
                        title: title, mediaType: mediaType, onOpen: openMedia),
                  ],
                  const SizedBox(height: 18),
                  _GlassContainer(
...
class _AmbientBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) => IgnorePointer(
        ...
        Positioned(
            top: -100, left: -90, child: _Glow(color: studioPurple, size: 260)),
        Positioned(
            top: 220, right: -110, child: _Glow(color: studioPink, size: 240)),
        Positioned(
            bottom: -120, left: 70, child: _Glow(color: studioBlue, size: 260)),
      ]));
}
...
class _GlassIcon extends StatelessWidget {
  ...
  const _GlassIcon(
      {required this.icon, required this.size, required this.iconColor});
  @override
  Widget build(BuildContext context) => ClipRRect(
      ...
      child: BackdropFilter(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(32),
                  border:
                      Border.all(color: Colors.white.withValues(alpha: .13))),
              child: Row(children: [
                Container(
                    width: 58,
                    height: 58,
                ...
                Expanded(
                    child: Column(
                      ...
                      Text(subtitle,
                          style:
                              const TextStyle(color: studioMuted, height: 1.35))
                    ]))
              ]))));
}
      ...
      child: GestureDetector(
          ...
          child: AnimatedContainer(
              ...
              child: Column(children: [
                Icon(icon,
                    size: 20, color: selected ? Colors.white : studioMuted),
                const SizedBox(height: 5),
                Text(label,
                    style: TextStyle(
                        fontSize: 12,
  ...
  Widget build(BuildContext context) => Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Text(title,
              style: const TextStyle(
                  fontWeight: FontWeight.w700, color: studioText)),
...
class _ResultGlass extends StatelessWidget {
  ...
  const _ResultGlass(
      {required this.title, required this.mediaType, required this.onOpen});
  @override
  Widget build(BuildContext context) => _GlassContainer(
      ...
      child: Column(children: [
        ...
        Text('$title created successfully',
            style: const TextStyle(
                color: studioText, fontWeight: FontWeight.w800, fontSize: 17)),
        const SizedBox(height: 5),
        const Text('Your generated media is ready to view.',
