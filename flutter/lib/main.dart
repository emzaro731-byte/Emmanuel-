    ...
    try {
      ...
      name.text =
          (row?['display_name'] ??
                  ...
                  'Destiny User')
              .toString();
      bio.text = (row?['bio'] ?? 'Exploring the future with Destiny AI.')
          .toString();
      setState(() {});
    } catch (_) {}
  }
        ...
        children: [
          Center(
            child: CircleAvatar(
              ...
              child: Text(
                display.isEmpty ? 'D' : display[0].toUpperCase(),
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(
      ...
      children: [
          ...
          child: Column(
            children: [
              ...
              SwitchListTile(
                ...
                subtitle: const Text('Keep a local backup of conversations'),
                value: saveHistory,
                onChanged: (v) {
        ...
        const Center(
          child: Text(
            'Destiny AI • Built for the future',
            style: TextStyle(color: muted),
          ),
        ),
      ],
